...
//     const notesContainer = document.getElementById("noteForm");

//     function fetchNotes() {
//       const formData = new URLSearchParams();
//       formData.append('user_id', 5); // Change 5 to the actual user ID
...
//                             <ul class="menu">
//                               <li onclick="updateNote('${note.subject}', '${note.title}', '${note.body}')"><i class="uil uil-pen"></i>Edit</li>
//                               <li onclick="deleteNote('${note.subject}')"><i class="uil uil-trash"></i>Delete</li>
//                             </ul>
//                             </div>
//                             `;
